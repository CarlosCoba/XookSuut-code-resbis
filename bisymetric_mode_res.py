...
def res_mod(galaxy, vel, evel, guess0, vary, n_it, rstart, rfinal, ring_space, frac_pixel, delta, pixel_scale,bar_min_max,errors, config, e_ISM, steps, method, use_metropolis):
		...
		if errors == 1:
			...
			from metropolis_hastings_res import bayesian_mcmc
